...
for i = 1:num_testing
    ...
    %vec_test = img_test(:);
    vec_test = multiscale_sobel_feature(img_test, scale);%go to function line 9 to change desired feature
    ...
    for j = 1:num_training
        ...
        %vec_train = img_train(:);
        vec_train = multiscale_sobel_feature(img_train, scale);%go to function line 9 to change desired feature
